      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-16 sm:mt-20">
          <div className="bg-slate-800 rounded-xl p-6 sm:p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Daily Tracking</h3>
          ...
          <div className="bg-slate-800 rounded-xl p-6 sm:p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Progress Journal</h3>
            <p className="text-gray-400">
        ...
        <div className="mt-16 sm:mt-20 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Add your daily activities and upload photos</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">
                3
              ...
              <p className="text-gray-400">View your progress and documentation history</p>
            </div>
          </div>
        </div>
      </main>
